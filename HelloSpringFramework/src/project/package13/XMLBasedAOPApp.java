...
public class XMLBasedAOPApp {

	public static void main(String[] args) {
		
		System.out.println("Inside main.");
		
		ApplicationContext context = new ClassPathXmlApplicationContext("Beans23.xml");
		...
		System.out.println("After calling printThrowException.");
